...
def main(N=5, dt=1.0e-5, useN=None, withdata=None, datapoints=100, mpass=1, grid=False, stride=1000, ifdrag=0, seed=42, rname=0, saveovito=1, trainm=0, runs=100, semilog=1, maxtraj=100, plotthings=True, redo=0):
    ...
    def acceleration_fn(params, graph):
        acc = fgn.cal_l(params, graph, mpass=1)
        return acc
