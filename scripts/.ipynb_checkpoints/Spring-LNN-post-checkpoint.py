...
def main(N=9, dt=1.0e-3, saveovito=0, datapoints=100, withdata=None, semilog=1, grid=0, ifdrag=0, trainm=0, stride=100, seed=42, rname=0, runs=10, maxtraj=1, plotthings=False):
