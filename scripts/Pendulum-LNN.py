...
def main(N=3, epochs=10000, seed=42, rname=True,
         dt=1.0e-5, stride=1000, ifdrag=0, lr=0.001, batch_size=100,datapoints=None, withdata=None):
    ...
    for epoch in range(epochs):
        ...
        if epoch % 10 == 0:
            ...
            if last_loss > larray[-1]:
                last_loss = larray[-1]
                savefile(f"lnn_trained_model_{ifdrag}_low.dil",
                        params, metadata={"savedat": epoch})
