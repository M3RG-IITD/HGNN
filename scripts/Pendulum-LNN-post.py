...
def main(N=2, dim=2, dt=1.0e-5, useN=None, ifdrag=0, saveovito=1, semilog=1, stride=1000, seed=42, rname=0, runs=100, maxtraj=100, plotthings=True,trainm=1):
    if useN is None:
        useN = N
    print("Configs: ")
    pprint(dt, stride,
    ...
    params = loadfile(f"lnn_trained_model_{ifdrag}.dil", trained=useN)[0]
