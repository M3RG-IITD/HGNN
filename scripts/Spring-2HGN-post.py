...
def main(N=5, dt=1.0e-3, useN=None, withdata=None, datapoints=100, mpass=1, grid=False, stride=100, ifdrag=0, seed=42, rname=0, saveovito=1, trainm=0, runs=200, semilog=1, maxtraj=100, plotthings=True, redo=0):
    ...
    # pred = acceleration_fn_model(R, V, params)
    # zdot_pred = jnp.vstack(jnp.split(pred, 2, axis=1))
    ...
    for ind in range(maxtraj):
        ...
        try:
            ...
            # perrrr = RelErr(actual_traj.velocity, pred_traj.velocity)
