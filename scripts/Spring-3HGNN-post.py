...
def main(N=5, dim=2, dt=1.0e-3, stride=100, useN=None, withdata=None, datapoints=100, grid=False, ifdrag=0, seed=42, rname=0, saveovito=1, trainm=0, runs=200, semilog=1, maxtraj=100, plotthings=True, redo=0):
