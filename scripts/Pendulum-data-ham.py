...
def main(N=5, dim=2, nconfig=100, saveat=100, ifdrag=0,dt = 1e-5, stride = 1000, runs=100, plottraj=True):
    tag = f"{N}-Pendulum-data-ham"
    seed = 42
    out_dir = f"../results"
    rname = False
    ...
    savefile(f"initial-configs___{ifdrag}.pkl", init_confs)
