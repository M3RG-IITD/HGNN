...
def main(N=5, dim=2, dt=1.0e-5,stride=1000, useN=None, withdata=None, datapoints=100, ifdrag=0, seed=100, rname=0, saveovito=1, trainm=0, runs=100, semilog=1, maxtraj=100, plotthings=True, redo=0):
    if useN is None:
        useN = N
